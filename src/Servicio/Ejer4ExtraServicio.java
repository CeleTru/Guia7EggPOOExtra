...
import Entidad.Ejer4ExtraEntidad;
import java.util.Scanner;

public class Ejer4ExtraServicio {

    Ejer4ExtraEntidad v1 = new Ejer4ExtraEntidad();
    Scanner leer = new Scanner(System.in).useDelimiter("\n");

    public  Ejer4ExtraEntidad crearNif() {
        System.out.print("Introduce el número de DNI: ");
        v1.setDni(leer.nextLong());

        // Array con las letras correspondientes a cada posición del resto de dividir el DNI por 23
        char[] letras = {'T', 'R', 'W', 'A', 'G', 'M', 'Y', 'F', 'P', 'D', 'X', 'B', 'N', 'J', 'Z', 'S', 'Q', 'V', 'H', 'L', 'C', 'K', 'E'};

        // Obtener el resto de dividir el DNI por 23
        int resto = (int) (v1.getDni() % 23);
//        System.out.println(resto);

        // Obtener la letra correspondiente al resto
        v1.setLetra(letras[resto]);
//        System.out.println(v1.getLetra());
        
        return v1; 

    }
    
        public  Ejer4ExtraEntidad  muestra() {
        String nif = String.format("%08d", v1.getDni()) + "-" + v1.getLetra();
